...
<template>
    ...
    <button v-bind:class="[{icon: displaySettings.stop.displayAsIcon}, globalClasses, displaySettings.stop.classes]" v-bind:style="globalStyles,displaySettings.stop.style" v-on:click="stop" v-if="displaySettings.stop.show"><i class="{{ displaySettings.stop.icons }}"></i> {{{ displaySettings.stop.text }}}</button>

    <button v-bind:class="[{icon: displaySettings.pause.displayAsIcon}, globalClasses, displaySettings.pause.classes]" v-bind:style="globalStyles,displaySettings.pause.style" v-on:click="pause" v-if="displaySettings.pause.show"><i class="{{ displaySettings.pause.icons }}"></i> {{{ displaySettings.pause.text }}}</button>
</template>
